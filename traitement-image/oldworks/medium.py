...
# img = cv2.imread('photos/resized.jpg')
not_resized_img = cv2.imread('plan_experience/1.png')
...
#   if (x < middle_width):
#     if (middle_width - x < middle_width - nearest_left):
#       nearest_left = x
#   else:
#     if (middle_width - x < middle_width - nearest_left):
#       nearest_right = x

# nearest_left = nearest_left-round(width*0.01)
# nearest_right = nearest_right - round(width*0.11)
# cv2.line(img,(nearest_left,0),(nearest_left,height),(0,0,255),2, cv2.LINE_AA)
# cv2.line(img,(nearest_right,0),(nearest_right,height),(0,0,255),2, cv2.LINE_AA)
...
# crop_img = img[0:height, nearest_left:nearest_right]
